...
type Skill struct {
	...
	// Schedulable declares that users may configure a personal schedule for
	// this skill (time + timezone). The creator sets this flag; the actual
	// schedule is stored per-user, not on the Skill itself.
